...
• Uses computer vision and reinforcement learning for navigation through dense environments, object/material detection, obstacle avoidance, loop detection, and safe landing.
          ...
          <a href="#" onclick="drone()" class="btn project-btn ">View Project</a>
        </div>
      </div>
    </div>
...
function drone() {
  ...
  <div class="container my-5">
    ...
    <h2 class="text-center mb-5">Drone Navigation System using Stereo Vision on Raspberry Pi</h2>

    <div class="row mb-5">
      <div class="col-md-4">
        <img src="images/drone.jpg" class="img-fluid rounded mb-3 shadow-sm" alt="Drone View 1">
      </div>
      <div class="col-md-4">
        <img src="images/drone_v2.jpg" class="img-fluid rounded mb-3 shadow-sm" alt="Drone View 2">
      </div>
      <div class="col-md-4">
        <img src="images/drone_v3.jpg" class="img-fluid rounded mb-3 shadow-sm" alt="Drone View 3">
      </div>
    </div>

    <div class="mb-5">
      <h3>Understanding Stereo Vision</h3>
      <p>
        Stereo vision is a technique that uses two cameras to capture images from slightly different perspectives, mimicking human binocular vision. By analyzing the disparities between the two images, the system can estimate depth and create a 3D representation of the environment. This allows the drone to perceive its surroundings in three dimensions, enabling it to navigate through complex environments, avoid obstacles, and perform tasks that require high spatial awareness.
      </p>
      
      <div class="row mt-4 mb-3">
        <div class="col-md-6">
          <img src="images/s1.jpg" class="img-fluid rounded mb-3 border" alt="Left Camera View">
        </div>
        <div class="col-md-6">
          <img src="images/s2.jpg" class="img-fluid rounded mb-3 border" alt="Right Camera View">
        </div>
      </div>
      
      <p ">
        <i class="bi bi-link-45deg"></i> <strong>Reference:</strong> 
        <a href="https://www.mathworks.com/help/vision/ug/uncalibrated-stereo-image-rectification.html" target="_blank" class="text-decoration-none">
          Uncalibrated Stereo Image Rectification (MathWorks)
        </a>
      </p>
    </div>

    <div class="mb-5">
      <h3>Hardware Architecture & Camera Calibration</h3>

<p>
The autonomous navigation platform consists of a Raspberry Pi 5, Ai Hat+ 26 Tops, dual Raspberry Pi NoIR cameras, a Pixhawk flight controller, and a custom power distribution system. The cameras are mounted with a fixed 6 cm baseline to provide sufficient parallax for depth estimation while maintaining a compact airframe design.
</p>

<p>
Accurate depth estimation requires precise camera calibration. Using OpenCV calibration tools and checkerboard-based intrinsic calibration, camera lens distortion parameters were estimated and removed. Stereo rectification was then performed to align corresponding image rows between both camera streams.
</p>

<p>
Image rectification significantly reduces the stereo search space, allowing correspondence matching to occur along horizontal scanlines only. This optimization improves disparity accuracy and reduces computational overhead on the Raspberry Pi's limited processing resources.
</p>
</div>
    <div class="mb-5">
      <h3>Disparity Map Generation & Analysis</h3>
      <p>
        To combine the two separate video feeds into a single depth map, I implemented a <strong>Stereo Block Matching (StereoBM / StereoSGBM)</strong> algorithm using OpenCV. The software takes a block of pixels from the left image and scans the right image to find the exact same block. The distance between where the block is in the left image versus the right image is called the <strong>disparity</strong>. Closer objects have a larger disparity, while faraway objects have a smaller one.
      </p>

      <div class="row mt-4">
        <div class="col-md-6">
          <img src="images/sv_1.png" class="img-fluid rounded mb-3 shadow-sm" alt="Original Scene">
          <p class="text-center">Original Rectified Frame</p>
        </div>
        <div class="col-md-6">
          <img src="images/sv2.png" class="img-fluid rounded mb-3 shadow-sm" alt="Depth Map Output">
          <p class="text-center ">Computed Disparity/Depth Map</p>
        </div>
      </div>

      <div class=" border-0 mt-3 p-4 rounded">
        <h5>Analyzing the Results & Addressing Noise</h5>
        <p class="mb-0">
          In the resulting right image, the depth of the scene is successfully visualized. The hand, being closer to the camera baseline, appears distinctly in the foreground compared to the background. 
          <br><br>
          <strong>Current Challenges:</strong> You will notice a significant amount of noise (black speckling and gaps) in the depth map. This is a common hurdle in computer vision caused by untextured surfaces (like plain walls), shadows, and varying lighting conditions that confuse the block-matching algorithm. To improve accuracy, I am currently experimenting with post-processing techniques, such as applying WLS (Weighted Least Squares) spatial filters and dynamically tuning the <code>numDisparities</code> and <code>blockSize</code> parameters to smooth the output.
        </p>
      </div>
    </div>
    ...
    <div class="text-center mb-5">
      ...
      <div class="mt-4">
        ...
        <a href="https://www.linkedin.com/posts/adidela-samson-tony_robotics-uav-computervision-ugcPost-7444362791647506432-66i1/?utm_source=share&utm_medium=member_desktop&rcm=ACoAADsMkYIBrT1862Cg8JRyvWTv-QDFSlNPVro" 
           target="_blank" class="btn project-btn mx-2 shadow-sm">View Recent Work</a>
      </div>
    </div>
  ...
  <ul>
    <li>Designed and assembled a custom UAV platform using Raspberry Pi and Pixhawk flight controller.</li>
    <li>Implemented stereo camera calibration and image rectification using OpenCV.</li>
    <li>Developed a real-time depth estimation pipeline using StereoBM and StereoSGBM algorithms.</li>
    <li>Generated disparity maps for obstacle detection and environmental perception.</li>
    <li>Integrated onboard computer vision processing for edge-based navigation.</li>
    <li>Investigated depth-map enhancement using WLS filtering and noise reduction techniques.</li>
    <li>Currently researching Visual SLAM, autonomous path planning, and obstacle avoidance systems.</li>
    <li>Targeting deployment of fully autonomous GPS-denied navigation capabilities.</li>
  </ul>
</div>
  </div>
  `;
